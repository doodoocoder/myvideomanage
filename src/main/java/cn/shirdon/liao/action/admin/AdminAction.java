package cn.shirdon.liao.action.admin;
...
import cn.shirdon.liao.exception.QingException;
import cn.shirdon.liao.service.user_info.UserInfoService;
import cn.shirdon.liao.util.MD5;
...
public class AdminAction {
	...
	public String center(ModelMap map) {
		...
		sb.append("	<div class='right'>高清视频系统1.0.0</div>");
	...
	public String service(ModelMap map) {
		...
		sb.append("	<div class='right'>ShirDon，QQ：823923263</div>");
		sb.append("	<span class='clearfix'></span>");
		sb.append("</div>");
