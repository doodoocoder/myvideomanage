package cn.shirdon.liao.dao.video_info;
...
public interface IVideoInfoDAO {
    ...
    /**
     * @param field 字段 open_opt，small_opt等
     * @param code  这些字段对应的值
     * @author chj
     * @date 2019/10/11 15:30
     * @description 根据字段及其值查询
     */
    List<BizVideo> listByMediaFieldValue(@Param("field") String field, @Param("code")String code);
/**
 *@author chj
 *@date 2019/10/12 17:41
 *@description video_info中的status为0的逻辑删除的
 *
 */
    VideoInfo selectByMediaIdEx(@Param("mId") String mId);

    List<VideoInfo> listNewVideo4Wx();
}	