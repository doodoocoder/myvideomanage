package cn.shirdon.liao.service.media_info;
...
import cn.shirdon.liao.util.VideoUtil;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import org.springframework.util.StringUtils;

import cn.shirdon.liao.constant.ErrorMsg;
import cn.shirdon.liao.dao.api_info.IApiInfoDAO;
import cn.shirdon.liao.dao.field_info.IFieldInfoDAO;
import cn.shirdon.liao.dao.field_profile_info.IFieldProfileInfoDAO;
import cn.shirdon.liao.dao.media_info.IMediaInfoDAO;
import cn.shirdon.liao.dao.tag_info.ITagInfoDAO;
import cn.shirdon.liao.dao.video_info.IVideoInfoDAO;
import cn.shirdon.liao.exception.QingException;
import cn.shirdon.liao.view.FieldInfo;
import cn.shirdon.liao.view.MediaInfo;
import cn.shirdon.liao.view.TagInfo;
...
public class MediaInfoService {
 ...
 //删除本地文件，节约空间
	    for(String mId : mediaIdArr){
            VideoInfo vi = iVideoInfoDAO.selectByMediaIdEx(mId);
			VideoUtil.deleteLocal(vi);
        }
