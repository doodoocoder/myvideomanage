    ...
    <ul class="weui-news-list">
        <c:forEach items="${pageInfo.list}" var="entity">
            <li class="weui-news-item">
                <div class="weui-news-inners">
                    <div class="weui-news-title"><a class=" weui-cell_access" href="${entity.url}">${entity.biaoti}</a></div>
                    <div class="weui-news-text">
                        <p class="weui-news-p">
                                ${fn:substring(entity.jianjie, 3, fn:indexOf(entity.jianjie,"<br>")-1 )}...
                    </div>
                    <div class="weui-news-info">
                        <div class="weui-news-infoitem">
                            <img src="${pageContext.request.contextPath}/static/wx/images/user.png" class="weui-news-round">
                            <span>微信小程序</span>
                        </div>
                ...
                <div class="weui-news-media">
                    <a href="${entity.url}"> <img
                            src="${entity.fengmian}"></a>
                </div>
        ...
        <li class="weui-news-item">
            <div class="weui-news-inner">
                <div class="weui-news-inners">
                    <div class="weui-news-text">
                        <div class="weui-news-title"><a href="http://www.baidu.com" class="weui-cell weui-cell_access">Flutter
                            是 Google 用以帮助开发者在 Android 和 iOS 两个平台，同时开发高质量原生应用的全新移动 UI 框架</a>
                        </div>
                    </div>
                    <div class="weui-news-info">
                        <div class="weui-news-infoitem">
                ...
                <div class="weui-news-media">
                    <a href="http://www.baidu.com" class="weui-cell weui-cell_access"> <img
                            src="${pageContext.request.contextPath}/static/wx/images/1.jpg"></a>
                </div>
            </div>
        </li>
        <li class="weui-news-item">
            <div class="weui-news-inner">
                <div class="weui-news-inners">
                    <div class="weui-news-text">
                        <div class="weui-news-title"><a href="http://www.baidu.com" class="weui-cell weui-cell_access">Google
                            在 2018 世界移动大会上发布 Flutter 的 Beta 版本</a></div>
                    </div>
                    <div class="weui-news-info">
                        <div class="weui-news-infoitem">
                            <img src="${pageContext.request.contextPath}/static/wx/images/user.png"
                ...
                <div class="weui-news-media">
                    <a href="http://www.baidu.com" class="weui-cell weui-cell_access"><img
                            src="${pageContext.request.contextPath}/static/wx/images/2.jpg"></a>
                </div>
            </div>
        </li>
        <li class="weui-news-item">
            <div class="weui-news-inner">
                <div class="weui-news-inners">
                    <div class="weui-news-text">
                        <div class="weui-news-title"><a href="http://www.baidu.com" class="weui-cell weui-cell_access">weui+最新版本包含更多组件</a>
                        </div>
                    </div>
                    <div class="weui-news-info">
                        <div class="weui-news-infoitem">
