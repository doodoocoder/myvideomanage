	...
	<div style="width: 1340px; margin: 20px auto;">
			...
			<div class="main-0">
				<div class="player">
					...
					<div id="player" style="width:1340px;height:720px;">
						<video width="1340px" height="720px" src="${videoInfo.url}"   type="video/mp4" controls="controls" autoplay  >
						</video>
					</div>
				</div>
			</div>
		...
		<div class="grid-25-8 spacing-20">
			<div>
						...
						<div class="grid-3-20 spacing-20">
							<div style="min-width: 140px;height: 210px;">
								<a href="profile.action?mediaId=${mediaInfo.media_id}" target="_blank">
									<img src="${mediaInfo.fengmian}" width="100%" height="100%" />
								</a>
							</div>
				...
				<!--评论 隐藏-->
				<div class="block no-shadow" style="display: none;">
					<div class="main">
						<!-- 评论列表 -->
