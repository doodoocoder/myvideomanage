...
<style>
	html{height:100%;}
	body{background: url(${pageContext.request.contextPath}/static/default/images/bj.jpg) no-repeat; width: 100%; height: 100%; background-size: 100% 100%;}
...
<body>
	<div class="form-data pos">
		<img src="${pageContext.request.contextPath}/static/default/images/login.png" class="head-logo">
		<!--表单-->
		<form id="login">
			<p class="p-input pos">
