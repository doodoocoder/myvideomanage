				...
				<div class="main">
					...
					<form id="form">
						...
						<div class="unit" >
							...
							<div class="right">
								<input type="text" class="text" readonly placeholder="上传视频成功后自动填入" id="url" name="url" value="${videoInfo.url}" data-type="必填" />
							</div>
							<!--清浮动-->
							<span class="clearfix"></span>
						</div>
...
<script>
	...
	javaex.upload({
		type : "file",
		url : "${pageContext.request.contextPath}/qiniu_info/upload_video.json",	// 请求路径
