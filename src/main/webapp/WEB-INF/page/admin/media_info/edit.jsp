						...
						<div class="unit">
							...
							<div class="right">
								<div class="grid-1-9">
									<div style="min-width:142px;">
										<!-- 图片承载容器 -->
										<label for="upload3" style="display: inline-block; width:200px;height:300px;">
											<c:choose>
									...
									<div style="position: relative;">
										<input type="text" id="fengmian" class="text" style="position: absolute;display:none;bottom: 0;width:84%;" name="fengmian" value="${mediaInfo.fengmian}" />
									</div>
								</div>
							</div>
							<!--清浮动-->
